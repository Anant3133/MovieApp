 ...
 * @property {string|number} [containerHeight]
 * @property {string|number} [containerWidth]
 * @property {string|number} [imageHeight]
 * @property {string|number} [imageWidth]
    ...
    >
      ...
      >
        ...
        {displayOverlayContent && overlayContent && (
          <motion.div
            className="absolute top-0 left-0 z-[2] will-change-transform [transform:translateZ(30px)] text-outline-black"
          >
            {overlayContent}
          </motion.div>
        )}
